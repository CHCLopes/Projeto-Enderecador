    ...
    return (
      <div ref={ref} className="print:w-full bg-gray-100 print:bg-white">
        {pages.map((pageItems, pageIndex) => (
          <div key={pageIndex} className="w-[210mm] h-[297mm] bg-white grid grid-cols-2 grid-rows-8 gap-x-1 gap-y-0 p-[5mm] box-border break-after-page mx-auto shadow-md print:shadow-none mb-4 print:mb-0">
            {pageItems.map((item, idx) => (
              <div key={idx} className="flex items-center justify-center border border-dashed border-gray-100 print:border-none">
